  ...
  return (
    <div className="relative h-[56.25vw]">
      ...
      <div className="absolute top-[30%] md:top-[40%] ml-4 md:ml-16">
        <p className="text-white text-6xl md:text-5xl h-full w-[30%] lg:text-6xl font-bold drop-shadow-xl">
          {data?.title}
        </p>
        <p className="text-white text-[14px] md:text-lg mt-3 md:mt-8 w-[50%] md:w-[60%] lg:w-[50%] drop-shadow-xl">
          {data?.description}
        </p>
